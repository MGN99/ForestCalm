    ...
    OVRInputModule.InputSource
{
    ...
    void Start()
    {
        // Reemplaza el contenido actual de Start() con esto:
        StartCoroutine(InitializeControllerModelsAfterDelay());
    }

    // Crea una nueva corrutina
    IEnumerator InitializeControllerModelsAfterDelay()
    {
        // Espera un frame
        yield return null;
